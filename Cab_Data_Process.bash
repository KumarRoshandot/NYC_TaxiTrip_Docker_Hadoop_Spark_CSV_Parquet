...
spark-submit --master $SPARK_MASTER_URL NYC_Road_Trip_Process.py $inpt_drive_file $input_zone_lookup_file $drive_parquet_folder $top5_paid_zone $longest5_trip_day
rc=$?
ENG_END_TIME=$(date +%s)
